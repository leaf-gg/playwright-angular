...
test.describe("Login page", () => {
    ...
    test("Shouldn't do login with invalid e-mail", async ({page}) => {
        const loginPage = new LoginPage(page);
    ...
    test("Shouldn't do login with incorrect format e-mail", async ({page}) => {
        const loginPage = new LoginPage(page);
    ...
    test("Shouldn't do login with empty fields", async ({page}) => {
        const loginPage = new LoginPage(page);
